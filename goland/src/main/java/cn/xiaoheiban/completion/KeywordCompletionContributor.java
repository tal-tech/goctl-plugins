...
public class KeywordCompletionContributor extends CompletionContributor implements DumbAware {
    private static final String[] keywords = new String[]{"map", "type", "bool", "uint8", "uint16", "uint32", "uint64", "int8", "int16", "int32", "int64", "float32", "float64", "complex64", "complex128", "string", "int", "uint", "uintptr", "byte", "rune",
            ...
            "group", "jwt", "struct", "doc", "server", "service", "info", "handler"};
